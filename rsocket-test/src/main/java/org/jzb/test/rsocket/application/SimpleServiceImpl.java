...
import org.jzb.test.rsocket.proto.SimpleRequest;
import org.jzb.test.rsocket.proto.SimpleResponse;
...
public class SimpleServiceImpl implements SimpleService {
    ...
    public SimpleServiceImpl(final String serviceName) {
    ...
    public Mono<SimpleResponse> streamingRequestSingleResponse(Publisher<SimpleRequest> messages, ByteBuf metadata) {
        return Flux.from(messages)
                ...
                .map(map -> {
                    ...
                    map.forEach((character, atomicInteger) -> builder
                            .append("character -> ")
                            .append(character)
                            .append(", count -> ")
